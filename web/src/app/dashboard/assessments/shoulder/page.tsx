...
export default function ShoulderAssessmentPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <div className="rounded-3xl border border-borderLight bg-white p-10 shadow-soft">
        <h1 className="text-4xl font-bold mb-4">Shoulder Assessment</h1>
        <p className="text-textSecondary mb-6">
          Start a shoulder pain assessment and generate a risk prediction.
        </p>
